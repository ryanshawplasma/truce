 ...
 *  - Only cards created against a real database are remembered. Hash-mode
 *    (/c/local#c=…) cards carry themselves inside their link and have no id
 *    or private page, so there is nothing useful to store.
 *
...
function normalise(raw) {
  ...
  return { id, editToken, toName, createdAt, unlockAt };
}
