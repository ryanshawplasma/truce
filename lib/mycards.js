...
import { safeOccasion } from './occasions';
...
function normalise(raw) {
  ...
  /* Entries saved before occasions existed have none — they were all apologies. */
  ...
  if (raw.kind === 'hash') {
    ...
    return { kind: 'hash', id: `hash:${fragment.slice(0, 48)}`, url, toName, occasion, createdAt, unlockAt: null };
  }
  ...
  return { kind: 'db', id, editToken, toName, occasion, createdAt, unlockAt };
}
