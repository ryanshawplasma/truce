...
export const CARD_LOOKS = {
  ...
  /* Raksha Bandhan: marigold and kumkum. Warm, gold-leaning, and the only
     theme whose accent is a red rather than a tint of its own background —
     the thread is the point, and it has to sit against the gold like one. */
  rakhi: {
    bg: 'linear-gradient(160deg,#FFF6E4 0%,#FFD79B 100%)',
    panel: '#FFFBF2',
    ink: '#4A1F14',
    soft: '#8A5A3C',
    accent: '#D4451F',
