...
export async function siteOrigin() {
  ...
  /* NOTE: VERCEL_URL is deliberately NOT used here. It names the unique
     per-deployment URL (truce-abc123.vercel.app) — ugly in share links, and
     with Vercel deployment protection it can send recipients to a Vercel
     auth screen instead of the card. The host the visitor is actually on
     (trucea.vercel.app or a custom domain) is always the right origin. */
